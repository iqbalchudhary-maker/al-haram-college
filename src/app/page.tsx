    ...
    <main className="flex flex-col min-h-screen scroll-smooth">
      ...
      <section id="home" className="relative bg-slate-50 pt-16 pb-24 lg:pt-28 overflow-hidden">
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Rotating Banner */}
          <div className="relative h-[400px] lg:h-[500px] rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white">
      ...
      <section id="about" className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="lg:w-1/2 bg-slate-200 h-[400px] w-full rounded-3xl flex items-center justify-center text-slate-400 font-bold">
              [About Section Image]
            </div>
          </div>
        </div>
